...
class SupervisorService {
    ...
    public function gradePSM1($data, $student){
        ...
        try{
            ...
            \Log::error('Error in gradePSM1 method: ' . $e->getMessage());
            throw $e;
        }
    ...
    public function gradePSM2($data, $student){
        ...
        try{
            ...
            \Log::error('Error in gradePSM2 method: ' . $e->getMessage());
            throw $e;
        }
    ...
    public function markahPSM1($data){
        ...
        try{
            ...
            \Log::error('Error in markahPSM1 method: ' . $e->getMessage());
            throw $e;
        }
    }
    ...
    public function markahPSM2($data){
        ...
        try{
            ...
            \Log::error('Error in markahPSM2 method: ' . $e->getMessage());
            throw $e;
        }
