...
export default function ResearchRubric() {
    ...
    const handleDeleteRubric = (id: number) => {
        ...
        if (isConfirmed) {
            router.delete(
                route("coordinator.PSM2.evaluationRubric.delete", id),
                {
                    preserveScroll: true,
                }
            );
    ...
    const handleRestoreRubric = (id: number) => {
        router.post(route("coordinator.PSM2.evaluationRubric.restore", id), {
            preserveScroll: true,
        });
    };

    const handleDeleteCriteria = (id: number) => {
        router.delete(route("coordinator.PSM2.evaluationCriteria.delete", id), {
            preserveScroll: true,
        });
    };
